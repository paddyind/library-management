...
export class BooksController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Create new book', description: 'Add a new book (Admin or Librarian)' })
  ...
  @Roles(MemberRole.ADMIN, MemberRole.LIBRARIAN)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Update book', description: 'Update book details including quantity (Admin or Librarian)' })
  ...
  @Roles(MemberRole.ADMIN, MemberRole.LIBRARIAN)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Delete book', description: 'Remove a book from the catalog (Admin or Librarian)' })
